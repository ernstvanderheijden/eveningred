...
class Configurationsummaryc(Basepackage, GlobalSummary):
    def __init__(self, request, pk=None):
        ...
        self.columnfields = {  # Fieldtypes are: boolean, char, date, applog, number, decimal, phone, sex, textarea, textarea_html, pill_list, editable_number, editable_dropdown, status_choice, status_contract, status_invoice
            "conditiontypeid__description": {
                "caption": "Standaard betalingstermijn",
                "fieldtype": "char",
            },
            "paymenttypeid__description": {
                "caption": "Standaard betaalwijze",
                "fieldtype": "char",
            },
            "email_to_accountancy": {
                "caption": "Accountancy e-mailadres",
                "fieldtype": "link",
            },
        }
