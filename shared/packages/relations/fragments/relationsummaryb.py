...
class RelationsummaryB(Basepackage, GlobalSummary):
    def __init__(self, request, pk=None):
        ...
        self.columnfields = {  # Fieldtypes are: boolean, boolean_true, char, date, email, number, decimal, phone, sex, textarea, textarea_html, pill_list, editable_number, editable_dropdown, status_choice, status_contract, status_invoice
            "is_debtor": {"caption": "Debiteur", "fieldtype": "boolean", },
            "is_creditor": {"caption": "Crediteur", "fieldtype": "boolean", },
            "debtornr": {"caption": "Debiteurnummer", "fieldtype": "char", },
            "creditornr": {"caption": "Crediteurnummer", "fieldtype": "char", },
            "conditiontypeid__description": {"caption": "Betalingstermijn", "fieldtype": "char", },
            "paymenttypeid__description": {"caption": "Betaalwijze", "fieldtype": "char", },
            "sendmethod": {"caption": "Verzendmethode", "fieldtype": "sendmethod_choice", },
